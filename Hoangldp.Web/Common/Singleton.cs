...
namespace Hoangldp.Core.Web.Common
{
    /// <summary>
    ...
    {
        private static readonly IDictionary<Type, object> ListSingleton;

        static Singleton()
        {
            ListSingleton = new Dictionary<Type, object>();
        }

        /// <summary>Dictionary of type to singleton instances.</summary>
        public static IDictionary<Type, object> AllSingletons
        {
            get { return ListSingleton; }
        }
    }
