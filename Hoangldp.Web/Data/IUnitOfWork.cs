...
namespace Hoangldp.Core.Web.Data
{
    ...
    public interface IUnitOfWork
    {
        ...
        /// <returns></returns>
        IRepository<TEntity> GetRepositoryFromEntity<TEntity>() where TEntity : IEntity, new();
        ...
        /// <returns></returns>
        IRepository<TEntity> Register<TEntity>(IRepository<TEntity> repository) where TEntity : IEntity, new();
