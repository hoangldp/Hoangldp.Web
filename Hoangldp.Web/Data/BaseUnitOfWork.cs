...
namespace Hoangldp.Web.Data
{
    ...
    public abstract class BaseUnitOfWork : IUnitOfWork
    {
        ...
        /// <returns></returns>
        public virtual IRepository<TEntity> GetRepositoryFromEntity<TEntity>() where TEntity : IEntity, new()
        {
        ...
        /// <returns></returns>
        public virtual IRepository<TEntity> Register<TEntity>(IRepository<TEntity> repository) where TEntity : IEntity, new()
        {
